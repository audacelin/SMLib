...
public final class DateUtil {
	...
	public static final DateFormat DEFAULT_TIME_FORMAT = new SimpleDateFormat(
			"HH:mm:ss");
	 ...
	 * @return 格式化字符串
	 */
	public synchronized static String date2String(Date date,
	 ...
	 * @return 格式化的字符串
	 */
	public synchronized static String time2String(Date time,
			DateFormat dateFormat) {
		if (time == null)
			return null;
	 ...
	 * @return 格式化字符串
	 */
	public synchronized static String dateTime2String(Date dateTime,
			DateFormat dateFormat) {
		if (dateTime == null)
			return null;
	...
	public static String fromUnixTime(Long ms) {
		return getDateString(new Date(ms.longValue() * 1000),
				"yyyy-MM-dd HH:mm:ss");
	}
